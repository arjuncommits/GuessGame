...
function guessNumber() {
    ...
    if (guess === randomNumber) {
        ...
        resultMessage.textContent = "Try large one";
        resultMessage.style.color = "white";
    } else if (guess > randomNumber) {
        resultMessage.textContent = "Try smaller one.";
        resultMessage.style.color = "white";
    } else {
        resultMessage.textContent = "Please enter a positive number.";
        resultMessage.style.color = "white";
    }
    attemptsMessage.textContent = `Balance Attempts: ${attempts}`;
}
function endGame() {
